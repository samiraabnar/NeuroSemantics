...
if __name__ == '__main__':
    ...
    for test_word_indices in itertools.combinations(range(len(word_set)), 2):
        ...
        if expSetup.mode == "train":
            ...
            lrm.save_model("../models/model_F25_" + word_set[test_word_indices[0]] + "-" + word_set[test_word_indices[1]])
        else:
            if os.path.isfile("../models/model_F25_"+word_set[test_word_indices[0]]+"-"+word_set[test_word_indices[1]]+".meta"):
                lrm.load_model("../models/model_F25_"+word_set[test_word_indices[0]]+"-"+word_set[test_word_indices[1]])
            else:
                lrm.load_model("../models/model_F25_"+word_set[test_word_indices[1]]+"-"+word_set[test_word_indices[0]])
